# Parallax — Technology Stack & Engineering Standards

**Goal:** Production-grade architecture for an AI engineering operations control plane.
...
- TanStack Query for server state where client fetching is necessary
- Zustand for small local UI state
- React Hook Form + Zod for forms
- Recharts or Apache ECharts for analytics
- Monaco only where code/diff inspection genuinely benefits
...
- fast navigation
- complex tables
- streaming mission state
- interactive command surfaces
- server-side access control
- accessible operational UI
- SEO for public surfaces if a marketing layer is later added
